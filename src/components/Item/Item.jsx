...
function Item({ item, stock, name, price, description, picture, category } ) {
  ...
  return (
    ...
    <><div className="cart-icon2"> size="1x" color="black" /{'>'}<div className="mostrar-cantidadItem">{getItemQuantity(item)}</div></div></>
    :
    <><div className="cart-icon2"> size="1x" color="black" /&gt;<div className="mostrar-cantidadItem">0</div></div></>
}</span>
